...
public class DesignSettingsPanel extends JPanel {
  ...
  Border border8;
  Border border9;
  JCheckBox ckUseImages = new JCheckBox();

  public DesignSettingsPanel() {
    ...
    ckUseImages.setSelected(UserSettings2.DES_USE_IMAGES);
  ...
  public void doOK() {
    ...
    UserSettings2.DES_USE_IMAGES = ckUseImages.isSelected();
  }
  ...
  private void jbInit() throws Exception {
    ...
    ckUseImages.setText("Use material images if available");
    ...
    jPanel3.add(rbnUseItemColor,   new GridBagConstraints(1, 2, 1, 1, 1.0, 1.0
            ,GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(0, 5, 0, 5), 0, 0));
    jPanel3.add(ckUseImages,   new GridBagConstraints(0, 3, 2, 1, 1.0, 1.0
            ,GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(0, 5, 0, 0), 0, 0));
