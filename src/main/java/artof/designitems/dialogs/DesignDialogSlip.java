...
public class DesignDialogSlip
  ...
  public DesignDialogSlip(String title, DesignItem2 item) {
    itemToEdit = item;
    setSize(300, 200);
  ...
  void btnColor_actionPerformed(ActionEvent e) {
    if (cbxItemCode.getSelectedIndex() > -1) {
      Color newColor = new JColorChooser().showDialog(null, "Display color",
          btnColor.getBackground());
      if (!newColor.equals(btnColor.getBackground())) {
        btnColor.setBackground(newColor);
        artof.database.ArtofDB.getCurrentDB().updateMaterialColor( (String)
            cbxItemCode.getSelectedItem(), newColor);
      }
    }
  }
  ...
  private void jbInit() throws Exception {
    ...
    border2 = BorderFactory.createCompoundBorder(new EtchedBorder(EtchedBorder.
    ...
    jPanel2.add(txtFace, new GridBagConstraints(1, 3, 1, 1, 0.0, 0.0
                                                ...
                                                GridBagConstraints.HORIZONTAL,
                                                new Insets(5, 5, 5, 30), 0, 0));
    jPanel2.add(lblSample, new GridBagConstraints(2, 3, 1, 1, 0.0, 0.0
                                                  ,
    ...
    jPanel2.add(jLabel3, new GridBagConstraints(2, 0, 1, 3, 0.0, 0.0
                                                , GridBagConstraints.NORTHWEST,
                                                GridBagConstraints.NONE,
                                                new Insets(7, 11, 3, 4), 0, 0));
    jPanel2.add(btnColor, new GridBagConstraints(3, 0, 1, 3, 0.0, 0.0
                                                 , GridBagConstraints.NORTHWEST,
                                                 GridBagConstraints.NONE,
                                                 new Insets(1, 6, 9, 19), 0, 0));
    jPanel2.add(jComboSupplier, new GridBagConstraints(1, 1, 2, 1, 0.0, 0.0
